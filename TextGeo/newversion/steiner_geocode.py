...
class SteinerGeo():
    ...
    def annotate(self, doc):
        ...
        doc['location_distribution'] = {loc: locdist[loc]['expansions'][stG.neighbors(loc+"T0").next()].__dict__ for loc in locdist if locdist[loc]['expansions']}
        if focus:
    ...
    def steiner_tree_approx(self, locationMap):
        ...
        for loc in locationMap:
            for rl in locationMap[loc]['expansions'].values():
                ...
                if rl.ltype == 'country':
                    edges = [(loc + "T0", rl.geonameid, eW), (rl.geonameid, rl.country, eW), (rl.country, 'E', eW)]
                elif rl.ltype == 'admin1':
                    edges =  [(loc + "T0", rl.geonameid, eW), (rl.geonameid, rl.admin1, eW), (rl.admin1, rl.country, eW), (rl.country, 'E', eW)]
                else:
                    #edges = [(loc + "T0", rl.geonameid, eW), (rl.geonameid, rl.name, eW), (rl.name, rl.admin1, eW), (rl.admin1, rl.country, eW), (rl.country, 'E', eW)]
                    edges = [(loc + "T0", rl.geonameid, eW), (rl.geonameid, rl.admin1, eW), (rl.admin1, rl.country, eW), (rl.country, 'E', eW)]

                G.add_weighted_edges_from(edges)
                terminalNodes.append(loc + "T0")
